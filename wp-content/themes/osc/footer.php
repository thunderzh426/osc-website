    ...
    <div class="bottom_footer" <?php echo "style='background-color:" . onepage_get_option( 'onepage_footer_bg_color', '#0d141b' ) . "'"; ?>>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="footer_social">
                        <li >
                            <a class="rss animated bounce" href="<?php echo esc_url( onepage_get_option( 'onepage_rss_link', '#' ) ); ?>" title="YouTube Channel" style="animation-delay: .8s"><i class="fa fa-fw fa-youtube"></i></a>
                        </li>
			...
			<li >
                    ...
                    <p><?php echo esc_attr( onepage_get_option( 'onepage_footer_copyright_text', 'Copyright &copy; oscgc.com' ) ); ?></p>
