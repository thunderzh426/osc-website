...
//Fetching all the categories for the post and displaying first pocket
    ...
    <div class="post_content">
        <?php
        $youtubelink = get_post_meta(get_the_id(),'you_tube_link',true);
        $linkexp_data = explode('?v=',$youtubelink);
        ?>
        <iframe width="730" height="350" src="https://www.youtube.com/embed/<?php echo $linkexp_data[1];?>" frameborder="0" allowfullscreen></iframe>
    </div>
    <div class="clear"></div>
</div>
<!--End Post-->
